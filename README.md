...
This code is not written by me. I found the code on the internet (I don't remember when or where). I might have changed the code that I found or I might just took this part of the code that I found. I don't remember exacty.
